...
public class AdminLog {
	...
	private static void log(String logLevel, String text) {
		if (AdminConfigManager.getBool("LOGGING") == true || logLevel == "[ERROR]" || logLevel == "[FATAL]"
				|| logLevel == "[WARN]")
			System.out.println(AdminConfigManager.getStr("NAME") + " " + logLevel + " " + text);
	}
	...
	public static void debug(String text) {
		if (AdminConfigManager.getBool("DEBUG_MODE") == true)
			log("[DEBUG]", text);
	}
