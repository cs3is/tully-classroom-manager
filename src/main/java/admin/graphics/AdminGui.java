		...
		question_Clear = new Button("Clear") {
			{
				...
				setOnAction(new EventHandler<ActionEvent>() {
					...
					public void handle(ActionEvent event) {
						...
						try {
							AdminMain.getAdminButtons().removeQuestion(AdminMain.getAdminData().out);
						} catch (Exception e) {
							e.printStackTrace();
						}
		...
		question_ClearAll = new Button("Clear All") {
			{
				...
				setOnAction(new EventHandler<ActionEvent>() {
					...
					public void handle(ActionEvent event) {
						...
						try {
							while(AdminMain.getAdminButtons().removeQuestion(AdminMain.getAdminData().out)!=null){
